...
namespace DevHelm\Control\Controller;
...
class FrontendController
{
    ...
    #[Route('/devhelm/{vueRouting}', name: 'app_main', requirements: ['vueRouting' => '.+'], defaults: ['vueRouting' => null])]
    #[Route('/devhelm/plan', name: 'app_plan', requirements: ['vueRouting' => '.+'], defaults: ['vueRouting' => null])]
