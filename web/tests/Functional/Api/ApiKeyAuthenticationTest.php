...
class ApiKeyAuthenticationTest extends WebTestCase
{
    ...
    /**
     * Test accessing the API with a key in query parameter
     */
    public function testApiAccessWithQueryParameterKey(): void
    {
        // Call the API with the key as a query parameter
        $this->client->request(
            'GET',
            '/api/v1/hello-world?api_key=' . $this->apiKey
        );
